...
if __name__ == '__main__':
    ...
    parser.add_argument('--shortcuts', type=int, default=8, help='how many shortcut layers will be pruned,\
        pruning one shortcut will also prune two CBL,yolove has 23 shortcuts')
    parser.add_argument('--global_percent', type=float, default=0.95, help='global channel prune percent')
